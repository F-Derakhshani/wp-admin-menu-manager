...
},matcher:function(a,b){return d(""+b).toUpperCase().indexOf(d(""+a).toUpperCase())>=0},separator:",",tokenSeparators:[],tokenizer:B,escapeMarkup:u,blurOnChange:!1,selectOnBlur:!1,adaptContainerCssClass:function(a){return a},adaptDropdownCssClass:function(){return null},nextSearchTerm:function(){return b},searchInputPlaceholder:"",createSearchChoicePosition:"top",shouldFocusInput:function(a){var b="ontouchstart"in window||navigator.msMaxTouchPoints>0;return b&&a.opts.minimumResultsForSearch<0?!1:!0}},a.fn.select2.locales=[],a.fn.select2.locales.en={formatMatches:function(a){return 1===a?"One result is available, press enter to select it.":a+" results are available, use up and down arrow keys to navigate."},formatNoMatches:function(){return"No matches found"},formatAjaxError:function(){return"Loading failed"},formatInputTooShort:function(a,b){var c=b-a.length;return"Please enter "+c+" or more character"+(1==c?"":"s")},formatInputTooLong:function(a,b){var c=a.length-b;return"Please delete "+c+" character"+(1==c?"":"s")},formatSelectionTooBig:function(a){return"You can only select "+a+" item"+(1==a?"":"s")},formatLoadMore:function(){return"Loading more results…"},formatSearching:function(){return"Searching…"}},a.extend(a.fn.select2.defaults,a.fn.select2.locales.en),a.fn.select2.ajaxDefaults={transport:a.ajax,params:{type:"GET",cache:!1,dataType:"json"}},window.Select2={query:{ajax:v,local:w,tags:x},util:{debounce:l,markMatch:t,escapeMarkup:u,stripDiacritics:d},"class":{"abstract":E,single:F,multi:G}}}}(jQuery),jQuery(function(a){a("a.smooth-scrolling-732").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var b=a(this.hash);if(b=b.length?b:a("[name="+this.hash.slice(1)+"]"),b.length)return a("html,body").animate({scrollTop:b.offset().top-120},1e3),!1}})}),function(a){a(document).ready(function(){wpammSubmenuSidebars=a(".wpamm-submenu-sortable"),a('.widget-content input[type="checkbox"]').change(function(){var b=a(this).parent().parent().parent().parent().parent().find(".widget-title");b.toggleClass("submenu-hidden")}),wpammSubmenuSidebars.sortable({placeholder:"widget-placeholder",items:"> .widget",handle:"> .widget-top > .widget-title",cursor:"move",distance:2,containment:"#wpcontent",start:function(b,c){var d,e=a(this),f=e.parent(),g=c.item.children(".widget-inside");"block"===g.css("display")&&(g.hide(),a(this).sortable("refreshPositions")),f.hasClass("closed")||(d=c.item.hasClass("ui-draggable")?e.height():1+e.height(),e.css("min-height",d+"px"))},stop:function(){},activate:function(){a(this).parent().addClass("widget-hover")},deactivate:function(){a(this).css("min-height","").parent().removeClass("widget-hover")},receive:function(b,c){var d=a(c.sender);return this.id.indexOf("orphaned_widgets")>-1?void d.sortable("cancel"):void(d.attr("id").indexOf("orphaned_widgets")>-1&&!d.children(".widget").length&&d.parents(".orphan-sidebar").slideUp(400,function(){a(this).remove()}))}})})}(jQuery),function(a){a(document).ready(function(){var b=a("#sidebar-primary"),c=a("#sidebar-footer");a(document).on("click",".wpamm-widget-send-to-disabled",function(b){b.preventDefault();var d=a(this).parent().parent().parent().parent().parent().parent();d.removeClass("open").children(".widget-inside").hide(),c.append(d),wpammSubmenuSidebars.sortable("refresh")}),a(document).on("click",".wpamm-widget-send-to-available",function(c){c.preventDefault();var d=a(this).parent().parent().parent().parent().parent().parent();d.removeClass("open").children(".widget-inside").hide(),b.append(d),wpammSubmenuSidebars.sortable("refresh")}),a(document).on("click",".wpamm-action-add-separator",function(b){b.preventDefault();var c=a("#sidebar-primary .widget").length+1e3+Math.floor(10*Math.random()),d='<div class="widget"><div class="widget-top"><div class="widget-title-action"><a class="wpamm-separator-delete" href="#"><i class="dashicons dashicons-dismiss"></i></a></div><div class="widget-title ui-sortable-handle"><h4 style="background-color: #fefefe !important;"><span data-wpamm-icon="dashicons-editor-insertmore" class="dashicons dashicons-editor-insertmore" style=""></span><span class="wp-admin-menu-title">Separator</span></h4></div></div><input class="order-carrier" type="hidden" name="menu[menu-'+c+'][order]" value="'+c+'"><input class="id-carrier" type="hidden" name="menu[menu-'+c+'][id]" value="separator-'+c+'"><input class="separator" type="hidden" name="menu[menu-'+c+'][separator]" value="1"></div>',e=a(d);e.insertAfter("#sidebar-primary .sidebar-description").hide().slideDown("fast",function(){wpammSubmenuSidebars.sortable("refresh")})}),a(document).on("click",".wpamm-separator-delete",function(b){b.preventDefault();var c=a(this).parent().parent().parent();c.slideUp("fast",function(){a(this).remove(),wpammSubmenuSidebars.sortable("refresh")})}),a("form#post").submit(function(){a(this).find("input").filter(function(){return!a.trim(this.value).length}).prop("disabled",!0)})})}(jQuery);var wpammWidgets;!function(a){wpammWidgets={init:function(){var b=a("div.wpamm-widgets-sortables");a("#widgets-right .sidebar-name").click(function(){var b=a(this),c=b.closest(".widgets-holder-wrap");c.hasClass("closed")?(c.removeClass("closed"),b.parent().sortable("refresh")):c.addClass("closed")}),a("#widgets-left .sidebar-name").click(function(){a(this).closest(".widgets-holder-wrap").toggleClass("closed")}),a(document.body).bind("click.widgets-toggle",function(b){var c,d,e,f,g,h=a(b.target),i={"z-index":100};h.parents(".widget-top").length&&!h.parents("#available-widgets").length?(c=h.closest("div.widget"),d=c.children(".widget-inside"),e=parseInt(c.find("input.widget-width").val(),10),f=c.parent().width(),d.is(":hidden")?(e>250&&e+30>f&&c.closest("div.widgets-sortables").length&&(g=c.closest("div.widget-liquid-right").length?isRTL?"margin-right":"margin-left":isRTL?"margin-left":"margin-right",i[g]=f-(e+30)+"px",c.css(i)),c.addClass("open"),d.slideDown("fast")):d.slideUp("fast",function(){c.attr("style",""),c.removeClass("open")}),b.preventDefault()):h.hasClass("widget-control-save")?(wpammWidgets.save(h.closest("div.widget"),0,1,0),b.preventDefault()):h.hasClass("widget-control-remove")?(wpammWidgets.save(h.closest("div.widget"),1,1,0),b.preventDefault()):h.hasClass("widget-control-close")&&(c=h.closest("div.widget"),c.removeClass("open"),wpammWidgets.close(c),b.preventDefault())}),b.sortable({placeholder:"widget-placeholder",items:"> .widget",handle:"> .widget-top > .widget-title",cursor:"move",distance:2,containment:"#wpcontent",start:function(b,c){var d,e=a(this),f=e.parent(),g=c.item.children(".widget-inside");"block"===g.css("display")&&(g.hide(),a(this).sortable("refreshPositions")),f.hasClass("closed")||(d=c.item.hasClass("ui-draggable")?e.height():1+e.height(),e.css("min-height",d+"px"))},stop:function(b,c){var d,e,f,g,h,i,j=c.item,k=0;return j.hasClass("deleting")?void j.remove():(d=j.find("input.add_new").val(),e=j.find("input.multi_number").val(),j.attr("style","").removeClass("ui-draggable"),the_id="",d&&("multi"===d?(j.html(j.html().replace(/<[^<>]+>/g,function(a){return a.replace(/__i__|%i%/g,e)})),j.attr("id",k.replace("__i__",e)),e++,a("div#"+k).find("input.multi_number").val(e)):"single"===d&&(j.attr("id","new-"+k),rem="div#"+k),j.find("input.add_new").val(""),a(document).trigger("widget-added",[j])),f=j.parent(),f.parent().hasClass("closed")&&(f.parent().removeClass("closed"),g=f.children(".widget"),g.length>1&&(h=g.get(0),i=j.get(0),h.id&&i.id&&h.id!==i.id&&a(h).before(j))),void(d&&j.find("a.widget-action").trigger("click")))},activate:function(){a(this).parent().addClass("widget-hover")},deactivate:function(){a(this).css("min-height","").parent().removeClass("widget-hover")},receive:function(b,c){var d=a(c.sender);return this.id.indexOf("orphaned_widgets")>-1?void d.sortable("cancel"):void(d.attr("id").indexOf("orphaned_widgets")>-1&&!d.children(".widget").length&&d.parents(".orphan-sidebar").slideUp(400,function(){a(this).remove()}))}}).sortable("option","connectWith","div.wpamm-widgets-sortables")},close:function(a){a.children(".widget-inside").slideUp("fast",function(){a.attr("style","")})},clearWidgetSelection:function(){a("#widgets-left").removeClass("chooser"),a(".widget-in-question").removeClass("widget-in-question")}},a(document).ready(function(){wpammWidgets.init()})}(jQuery);