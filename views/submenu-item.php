    ...
    <div class="widget-inside" style="padding: 15px;">
      ...
      <div class="widget-content">
        <p>
          ...
          <br><?php _e('Change the name of this submenu item.', $this->textDomain); ?>
          ...
          <span class="wpamm-title"><?php _e('Custom Link', $this->textDomain); ?></span>
          <br><?php _e('Set a custom link for the submenu item.', $this->textDomain); ?>
          ...
          <span class="wpamm-title"><?php _e('Hide Submenu?', $this->textDomain); ?></span>
          </label>
        </p>
      </div>
