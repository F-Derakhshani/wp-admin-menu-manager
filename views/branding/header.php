	...
	<div class="header-732">
		...
		<div class="author-732">
			<a href="http://codecanyon.net/user/732">
				<img src="<?php echo $this->getAsset('author.png'); ?>" alt="<?php _e('Check out our premium plugins!', $this->textDomain); ?>">
			</a>
		</div>
		...
		<div class="header-732-desc" style="<?php echo ($this->expandHeader) ? '' : 'display: none;'; ?>">
			...
			<a href="#about-732" class="button button-primary button-hero smooth-scrolling-732"><?php _e('Show me how!', $this->textDomain); ?></a>
			<!-- <a href="#"><?php _e('or continue to the plugin', $this->textDomain); ?></a> -->
		</div>
	</div>
</div>